	...
	$(document).ready(
			function() {
				...
				$('.pwCheck_i').on(
						'click',
						function() {
							$('#pwCheck').toggleClass('active');
							if ($('#pwCheck').hasClass('active')) {
			...
			<div class="member-container">
				...
				<div class="form-group" style="margin-bottom: 0;">
					...
					<div class="input-group" style="width: 69%">
						<input type="email" class="form-control pl-1r" id="user_id"
							value="${memberDTO.user_id}" placeholder="이메일을 입력해 주세요."
							name="user_id" style="width: 69%">
						<div class="input-group-btn"
							style="padding-bottom: 0; padding-top: 0;">
							<button class="btn btn-default p2-10" type="button"
								id="emailCheck-Btn" style="background-color: #dcdcdc;">이메일
								인증</button>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<input type="text" class="form-control pl-1r" id="authInput"
						placeholder="인증번호를 입력해 주세요." name="authInput" disabled="disabled">
				...
				<div class="form-group pw">
					...
					<div class="pw_div" style="position: relative;">
					<input type="password"
						class="form-control pl-1r" id="pwCheck"
						value="${memberDTO.pwCheck}" placeholder="비밀번호를 한번 더 입력해 주세요."
						name="pwCheck"> 
						<div style="padding-top: 0; position: absolute; top: 25%; right: 5%;">
							<i class="fa fa-eye fa-lg pwCheck_i" style="width: 20px; height: 100%"></i> 
						</div>
					</div>
				</div>
						<span id="pwCk"></span>
				...
				<div class="form-group" style="margin-bottom: 5px;">
					<label for="name">이름</label> <input type="text"
						class="form-control pl-1r" id="name" name="name"
						value="${memberDTO.name}" placeholder="이름을 입력하세요.">
					<%
						if (valid_name != null) {
					%>
				...
				<div class="form-group">
					<label for="birthDate">생년월일</label> <input type="date"
						class="form-control pl-1r" id="birthDate" name="birthDate"
						value="${memberDTO.birthDate}" placeholder="생년월일을 입력하세요.">
					<%
				...
				<div class="form-group">
					<label for="phNum">전화 번호</label> <input type="text"
						class="form-control pl-1r" id="phNum" value="${memberDTO.phNum}"
						placeholder="-를 포함하여 11자리를 입력해 주세요." name="phNum">
					<%
						if (valid_phNum != null) {
					%>
				...
				<button type="submit" class="btn bt-1" id="signUp" name="signUp"
					disabled="disabled">가입하기</button>
				&ensp;&nbsp;
				<button type="button" class="btn p2-10 bt-1" name="noSignUp"
					onclick="location.href='index.jsp'">가입취소</button>
			</div>
		</form>
		<div class="member-container">
			<div class="form-group" style="margin-bottom: 0px;">
				<p style="text-align: center; font-size: small; margin: 13px 0px;">
					맛.zip의 회원이신가요? <a href="login"
						style="font-size: small; color: #ffc107; font-weight: 700; padding-left: 5px;">로그인</a>
				</p>
			</div>
		</div>
	</div>
